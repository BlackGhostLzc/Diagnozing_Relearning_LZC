...
class CRAMED_dataset(object):
    def __init__(self, path_to_dataset = '/root/autodl-tmp/CREMA-D', frame_interval=1, frame_kept_per_second=1):
    ...
    def extractImage(self):
        ...
        for each_video in self.file_list:
            ...
            self.videoReader.video2frame_per_second(frame_save_path=save_dir)
